...
<div id="box1"><?php previous_post_link('<div class="alignleft">Tidligere Indl&aelig;g: %link</div>', '%title'); ?>
	<?php if(!get_adjacent_post(false, '', true)) { 
		echo '<div class="alignleft"><a href="http://perishablepress.com/press/archives/">Site Archives</a></div>'; 
	} ?>

	<?php next_post_link('<div class="alignleft">N&aelig;ste indl&aelig;g   : %link</div>', '%title'); ?>
	</div>
<div id="box2"></div>
<div id="box3"></div>
