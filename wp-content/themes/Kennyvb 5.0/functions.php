...
function add_our_scripts() {
	...
	// Twitter scripts
	//wp_register_script( 'kennytwit', $scriptdir.'/js/kennyvb.js', false, '4.0');
	//wp_register_script( 'jquerytweet', $scriptdir.'/js/jquery.tweet.js', false, '4.0');
	
    //load the scripts and style.
    wp_enqueue_script('jquery');
	//wp_enqueue_script('kennytwit');
	//wp_enqueue_script('jquerytweet');
...
function twentyten_continue_reading_link() {
	return ' <a href="'. get_permalink() . '">' . __( 'Fors&aelig;t l&aelig;sning <span class="meta-nav">&rarr;</span>', 'twentyten' ) . '</a>';
}
